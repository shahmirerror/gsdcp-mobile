...
function MatingRow({
  ...
  return (
    <TouchableOpacity
      ...
      onPress={onPress}
      activeOpacity={0.7}
      data-testid={`card-mating-${mating.id}`}
    >
      ...
      <View style={styles.itemInfo}>
        <View style={styles.kennelNameRow}>
          {mating.kennel_image ? (
            <LazyImage
              source={{ uri: mating.kennel_image }}
        ...
        <View style={styles.dogRow}>
          {mating.sire.imageUrl ? (
            <LazyImage
              source={{ uri: mating.sire.imageUrl }}
        ...
        <View style={styles.dogRow}>
          {mating.dam.imageUrl ? (
            <LazyImage
              source={{ uri: mating.dam.imageUrl }}
              style={styles.dogAvatar}
            />
          ) : (
            <View style={[styles.dogAvatar, styles.dogAvatarPlaceholder]}>
...
export default function RecentMatingsScreen() {
  ...
  const activeFilterCount =
    (cityFilter !== "All" ? 1 : 0) + (litterFilter ? 1 : 0);
        ...
        <View style={styles.activeFiltersRow}>
          ...
          {litterFilter && (
            <View style={[styles.activeChip, styles.activeChipGreen]}>
              ...
              <TouchableOpacity
                onPress={() => setLitterFilter(false)}
                data-testid="btn-remove-litter-filter"
              >
      ...
      >
        <View style={styles.modalContent}>
          ...
          <TouchableOpacity
            style={[
              styles.litterToggle,
              tempLitter && styles.litterToggleActive,
            ]}
          ...
          >
            <Ionicons
              name="paw"
              size={16}
              color={tempLitter ? "#fff" : COLORS.primary}
            />
            <Text
              style={[
                styles.litterToggleText,
                tempLitter && styles.litterToggleTextActive,
              ]}
            >
              Litter on Ground
            </Text>
            <View
              style={[
                styles.toggleSwitch,
                tempLitter && styles.toggleSwitchActive,
              ]}
            >
              <View
                style={[
                  styles.toggleThumb,
                  tempLitter && styles.toggleThumbActive,
                ]}
              />
            </View>
          </TouchableOpacity>
