...
function credentialColor(credentials: string): { bg: string; text: string } {
  ...
  if (c.includes("körmeister"))
    return { bg: "rgba(15,92,58,0.08)", text: COLORS.primary };
  return { bg: "rgba(15,92,58,0.08)", text: COLORS.primary };
}

function VisitingJudgeCard({
  judge,
  onPress,
}: {
  judge: JudgeItem;
  ...
  return (
    <TouchableOpacity
      ...
      onPress={onPress}
      activeOpacity={0.75}
      data-testid={`card-visiting-judge-${judge.judge_id}`}
    >
        ...
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.heroSub}>
              International judges & specialists
            </Text>
            <TouchableOpacity
